...
namespace Server.Controllers
{
    ...
    public class PaymentsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Pay()
        {
            Options options = new()
            {
                ApiKey = "sandbox-N6n6PQsDIMDpRbOzJg5kcFEF8Qk93Cu1",
                SecretKey = "sandbox-pwwDb5iKecRwbZlC4BkTiwrDzJLOYZsq",
            ...
            request.CallbackUrl = "https://localhost:7192/api/Payments/PayCallBack";
